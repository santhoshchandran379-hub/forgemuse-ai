...
Intelligent lyrics improvement
Story generation
Script writing
Blog creation
...
The platform also allows users to save projects, revisit previous work, refine generated content, and export it in multiple formats including PDF, DOCX, and TXT.
🤖 AI Creative Modules
ForgeMuse AI includes multiple specialized AI-powered creative modules.
Module
Responsibility
🎵 Song Creator
Generates complete songs including verses, chorus, bridge, outro, chord progression, musical key, and tempo
✍️ Lyrics Improver
Enhances existing lyrics by improving rhyme, flow, emotion, and imagery
📖 Story Generator
Creates original stories with structured chapters, characters, and alternative endings
🎬 Script Writer
Generates original movie and short-film scripts while avoiding copyrighted content
📝 Blog Writer
Produces SEO-optimized blogs with headings, structured sections, and conclusions
📱 Social Media Generator
Creates optimized posts for Instagram, Twitter/X, LinkedIn, Facebook, and other platforms
📣 Advertisement Creator
Produces persuasive marketing copy with multiple headline and CTA variations
💬 AI Chat Assistant
Provides conversational creative guidance and helps users refine their ideas
...
ForgeMuse AI sends the structured request to IBM Granite AI through Watsonx.
...
└─────────────────┘          └─────────────────┘
The frontend provides a modern and responsive interface where users interact with the AI-powered creative modules. Requests are securely sent to the Express.js backend, which manages authentication, communicates with IBM Granite AI, and stores projects in MongoDB Atlas.
⚡ AI Workflow
...
Users choose the creative tool they need, such as:
Song Creator
Lyrics Improver
Story Generator
Script Writer
...
Step 7 — Export
Projects can be exported in TXT, PDF, or DOCX formats.
🛠️ Technology Stack
Frontend
Next.js 14
React
...
Project Planning
IBM Bob assisted in planning the application's architecture, organizing project modules, and defining the overall creative workflow before implementation.
Code Generation
...
Backend API URL
Application Name
Sensitive credentials such as API keys, database passwords, JWT secrets, and email credentials are excluded from the public repository through .env files.
📡 Core API Endpoints
Authentication
...
🎥 Demo Video
Public Demo Video
YouTube Link: (Add your video link here after uploading.)
...
ForgeMuse AI empowers users to focus on creativity while AI assists with content generation, refinement, and organization.
...
One Prompt
   ...
   ▼
One AI Response
ForgeMuse AI follows a richer workflow:
                    User
                      │
                      ▼
              Creative Idea
...
These enhancements will continue expanding ForgeMuse AI into a comprehensive AI-powered creative production platform.
